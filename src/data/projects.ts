...
// 'web', 'science', 'ml', 'quant', 'other'
// will end up adding more as more projects are made public

const projects: ProjectType[] = [
  {
    id: 1,
    title: "PyBWT",
    description: "A Python implementation of the Burrows-Wheeler Transform (BWT) for efficient text compression, pattern matching, and lossless data transformation in bioinformatics and data processing.",
  ...
  },
  {
    id: 2,
    title: "Pathfinder",
    description: "A bioinformatics tool that predicts genomic pathways, interactions, and regulatory networks using RNA-Seq time-series data and computational modeling techniques.",
  ...
  },
  {
    ...
    description: "A C++ tool for real-time portfolio return analysis, leveraging non-linear optimization and efficient data structures for quantitative finance applications.",
  ...
  },
  {
    ...
    description: "A deep learning-based U-Net model for surgical tool segmentation in endoscopic images, optimized for robustness against occlusions and real-world medical imaging tasks.",
  ...
  },
  {
    id: 5,
    title: "Medslate",
    description: "An AI-powered web app that transcribes medical appointments and generates patient-friendly summaries and follow-up questions using OpenAI and AWS.",
